    ...
    return (
        <div
            style={{
                ...
                position: "relative",
                overflow: "visible",
                background: isDone ? "#f3f4f6" : "#ffffff",
                color: isDone ? "#6b7280" : "#111827",
                border: `1px solid ${isDone ? "#9ca3af" : color}`,
                borderLeft: `6px solid ${isDone ? "#9ca3af" : color}`,
                                ...
                                onClick={(e) => {
                                    ...
                                    if (data?.parentModulePayload && data?.onRemoveModuleFromPlan) {
                                        ...
                                        const confirmed = window.confirm(
                                            `This course belongs to ${moduleName}. Removing it will remove all module courses from your plan. Continue?`
                                        );
                                        if (!confirmed) return;
                                    ...
                                    <button
                                        ...
                                        onClick={(e) => {
                                            ...
                                            if (data?.parentModulePayload && data?.onAddModuleToPlan) {
                                                const courseLabel = data?.courseCode || data?.courseName || "This course";
                                                const confirmed = window.confirm(
                                                    `${courseLabel} belongs to a module. Adding it will automatically add all module courses. Continue?`
                                                );
                                                if (!confirmed) return;
